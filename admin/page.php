...
<?php 
    ...
    {
        echo "<script>window.location = 'index.php';</script>";//using js
                    ...
                    <table class="form">
						...
						<tr>
                            ...
                            <td>
                                ...
                                <span class= "actiondel"><a onclick = "return confirm('Are you sure to delete?');" href = "delpage.php?delid=<?php echo $result['id'];?>">Delete</a></span>
                            </td>
                        </tr>
                    </table>
                    </form>
